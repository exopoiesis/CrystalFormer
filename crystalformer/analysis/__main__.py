"""CLI entry point: ``python -m crystalformer.analysis``.
...
Usage examples::
    ...
    # Custom output path
    python -m crystalformer.analysis structures.csv -o results.csv
...
from crystalformer.analysis.percolation import PercolationAnalyzer
from crystalformer.analysis.voronoi import VoronoiAnalyzer
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        prog="python -m crystalformer.analysis",
